...
describe("Attack", function () {
  it("After being declared the winner, Attack.sol should not allow anyone else to become the winner", async function () {
    ...
    await tx.wait();
    console.log("Winner Address", await _goodContract.currentWinner());
    ...
    // Now lets trying making addr3 the current winner of the auction
    tx = await _goodContract.connect(addr3).setCurrentAuctionPrice({
